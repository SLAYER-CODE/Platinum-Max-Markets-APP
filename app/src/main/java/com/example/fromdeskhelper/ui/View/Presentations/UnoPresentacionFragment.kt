...
@AndroidEntryPoint
class UnoPresentacionFragment : Fragment() {
    ...
    private var _binding: FragmentUnoPrecentacionBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUnoPrecentacionBinding.inflate(inflater, container, false)
