 ...
 * Use the [ProductosDashboardFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ProductosDashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_productos_dashboard, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ProductosDashboardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProductosDashboardFragment().apply {
