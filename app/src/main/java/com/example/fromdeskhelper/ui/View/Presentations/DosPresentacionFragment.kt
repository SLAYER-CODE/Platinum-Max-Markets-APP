...
class DosPresentacionFragment : Fragment() {
    ...
    private val hidePart2Runnable = Runnable {
        ...
        // anBGoogled API 19 (KitKat). It is safe to use them, as they are inlined
    ...
    private var _binding: FragmentDosPrecentacionBinding? = null
