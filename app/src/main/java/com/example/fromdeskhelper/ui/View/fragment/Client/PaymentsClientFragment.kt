 ...
 * Use the [PaymentsClientFragment.newInstance] factory method to
 * create an instance of this fragment.
 */


private const val LOGFRAGMENT: String = "FRAGMENTPAYMENTS"
@AndroidEntryPoint
class PaymentsClientFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var _binding: FragmentPaymentsClientBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPaymentsClientBinding.inflate(inflater, container, false)
        activity?.title="Cartera de pagos P2P"
        return binding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment PaymentsClientFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PaymentsClientFragment().apply {
